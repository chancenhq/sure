class UsersController < ApplicationController
  ...
  private
    def handle_redirect(notice)
      ...
      when "partner_onboarding_preferences", "chancen-ke_onboarding_preferences", "chancen_onboarding_preferences"
      ...
      when "partner_onboarding_goals", "chancen-ke_onboarding_goals", "chancen_onboarding_goals"
        partner_key = active_partner_key
        return redirect_to settings_profile_path, notice: notice if partner_key.blank?
      ...
      when "partner_onboarding_trial", "chancen-ke_onboarding_trial", "chancen_onboarding_trial"
        partner_key = active_partner_key
        return redirect_to settings_profile_path, notice: notice if partner_key.blank?
